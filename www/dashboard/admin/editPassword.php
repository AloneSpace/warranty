...
<body>
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                ?>
                    ...
                    <ul class="sub-menu collapse" id="new">
                        ...
                        <li class="active"><a href="editPassword.php">เปลี่ยนรหัสผู้ใช้</a></li>
    ...
    <div style="padding-left: 350px; padding-top: 30px; padding-right: 50px; width: 1000px;">
        <h1>เปลี่ยนรหัสผู้ใช้ (Admin)</h1>
        <hr>
        <div class="card">
            <div class="card-body">
                <h4 style="padding-bottom: 20px;">สำหรับเปลี่ยนรหัสผู้ใช้งาน</h4>
                <!-- Form -->
        ...
        $(document).ready(function() {
            $("#btnSend").click(function() {
                ...
                if (password != confirmpassword) {
                    Swal.fire({
                        icon: "error",
                        title: "รหัสผ่านทั้งสองอันไม่เหมือนกัน",
                ...
                $.ajax({
                    dataType: 'json',
                    type: 'POST',
                    url: '../../controller/admin/editPassword.php',
                    data: {
                        username: username,
                        password: password
                    },
